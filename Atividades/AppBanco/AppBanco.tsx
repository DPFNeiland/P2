        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View style={styles.headHeader}>
                    <MaterialCommunityIcons onPress={Mensagem} name="menu" size={20} color='#fff'></MaterialCommunityIcons>
                    <MaterialCommunityIcons onPress={Mensagem} name="bell-outline" size={20} color='#fff'></MaterialCommunityIcons>
                </View>
